  ...
  return (
    <section className={`team ${darkMode ? 'dark-mode' : ''}`}>
      <div className="center">
        <h1 className={darkMode ? 'dark-mode' : ''} activeclassname="active">
      ...
      <div className={`team-content ${darkMode ? 'dark-mode' : ''}`}>
        <div className={`box ${darkMode ? 'dark-mode' : ''}`}>
          ...
          <h3 className={darkMode ? 'dark-mode' : ''} activeclassname="active">
            Abhishek K
          </h3>
          <h5 className={darkMode ? 'dark-mode' : ''} activeclassname="active">
            Designer
          </h5>
          <div className={`icons ${darkMode ? 'dark-mode' : ''}`}>
            <a href="https://twitter.com/bobsstwt" target="_blank">
              <i
                className={`ri-twitter-fill ${darkMode ? 'dark-mode' : ''}`}
              ></i>
            </a>
            <a href="https://github.com/bobbyy16" target="_blank">
              <i
                className={`ri-github-fill ${darkMode ? 'dark-mode' : ''}`}
              ></i>
            </a>
            <a
            ...
            >
              <i
                className={`ri-linkedin-fill ${darkMode ? 'dark-mode' : ''}`}
              ></i>
            </a>
          </div>
        </div>
